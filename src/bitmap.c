 ...
 * Returns a pointer to the bitmap if successful, NULL otherwise...
 */
byte *LoadDIBitmap(const char *filename, BITMAPINFO **info, BITMAPFILEHEADER* header)    /* O - Bitmap information */
{
    FILE* fp;          /* Open file pointer */
    byte* bits;        /* Bitmap pixel bits */
...
int SaveDIBitmap(const char *filename, BITMAPINFO *info, byte *bits)     /* I - Bitmap data */
{
    FILE *fp;                      /* Open file pointer */
    int  size,                     /* Size of file */
            infosize,                 /* Size of bitmap info */
